...
// managed-integrity-v1: G1GLesSMhcc
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-web-openai", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-web-openai")
        description.set("Kotlin Multiplatform client for the OpenAI API, with typed requests, streaming support, multipart uploads, and live-smoke-tested high-risk endpoints.")
        url.set("https://github.com/wabbit-corp/kotlin-web-openai")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-web-openai")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-web-openai.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-web-openai.git")
        }
    }
}
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-web-openai"
...
kotlin {
    ...
    androidLibrary {
        namespace = "one.wabbit.web.openai"
        compileSdk = 34
        minSdk = 26
    }
...
plugins.withId("org.jetbrains.dokka") {
    afterEvaluate {
        extensions.findByType(DokkaExtension::class)?.apply {
            moduleName.set("kotlin-web-openai")
            ...
            dokkaSourceSets.configureEach {
                ...
                sourceLink {
                    ...
                    remoteUrl("https://github.com/wabbit-corp/kotlin-web-openai/tree/master/src")
